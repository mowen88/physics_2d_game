...
CONTROLLERS = {
			'Nintendo Switch Pro Controller':
				...
				'L Trigger':0, 'R Trigger':0, 'A':0, 'B':0, 'X':0, 'Y':0, '-':0, 'Home':0, '+':0, 'LS In':0, 'RS In':0,
				'L Bumper':0, 'R Bumper':0, 'D-pad Left':0, 'D-pad Right':0 , 'D-pad Up':0, 'D-pad Down':0, 'Capture':0},

			'PS4 Controller':
				{'LS Left':0, 'LS Right':0, 'LS Up':0, 'LS Down':0, 'RS Left':0, 'RS Right':0, 'RS Up':0, 'RS Down':0, 'L Trigger':0,
				'R Trigger':0, 'Cross':0, 'Circle':0, 'Square':0, 'Triangle':0, 'Share':0, 'PS':0, 'Options':0, 'LS In':0, 'RS In':0,
				'L Bumper':0, 'R Bumper':0, 'D-pad Left':0, 'D-pad Right':0 , 'D-pad Up':0, 'D-pad Down':0, 'Touch Pad':0},
			}
